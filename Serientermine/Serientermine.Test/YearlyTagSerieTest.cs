...
{
    internal class YearlyTagSerieTest
    {
        ...
        public void TestWithinRange()
        {
            ...
            var expected = new List<DateTime> { new(2021, 4, 15), new(2024, 4, 15), new(2027, 4, 15) };
        ...
        public void TestBeginWithinRange()
        {
            ...
            var expected = new List<DateTime> { new(2021, 4, 15), new(2024, 4, 15) };
            Assert.That(actual, Is.EquivalentTo(expected));
        }
        ...
        public void TestEndWithinRange()
        {
            ...
            var expected = new List<DateTime> { new(2021, 4, 15), new(2024, 4, 15), new(2027, 4, 15), new(2030, 4, 15) };
            Assert.That(actual, Is.EquivalentTo(expected));
        }
    }
}
